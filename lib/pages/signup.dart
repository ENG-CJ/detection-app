                    ...
                    checkExistance(email, mobile).then((value) {
                      ...
                      if (!Validator().isEmailValid(email)) {
                        CoolAlert.show(
                            ...
                            title: "Email Format",
                            text:
                                "Incorrect Email Format use (example@gmail.com)");
                        return;
                      }
                      if (!Validator().containsOnlyLettersAndSpaces(name)) {
                        CoolAlert.show(
                            ...
                            title: "Name Format",
                            text:
                                "FullName Must contain only letters and characters");
                        return;
                      }
                      if (!Validator().isFullNameValid(name)) {
                        CoolAlert.show(
                            ...
                            title: "Name Length",
                            text:
                                "Please Provide Your FullName in order to make valid order");
                        return;
                      }
