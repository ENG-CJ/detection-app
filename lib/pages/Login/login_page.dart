...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<bool> authenticate() async {
    ...
    try {
      ...
      if (responseData['status']) {
        ...
        if (responseData['data'].length > 0) {
          LocalStorage().createLocalData({
            ...
            "pass": responseData['data']['password'],
      ...
      setState(() {
        ...
        hasError = true;
        logging = false;
        errorDescr = responseData['message'];
      });
    } catch (e) {
      setState(() {
  ...
  Future<bool> validateEmail() async {
    ...
    bool hasData = false;
    try {
      Response response = await dio.post("$URL/customers/validateEmail",
          data: {"email": validationEmail});
  ...
  Future<void> updatePassword() async {
    try {
      Response response = await dio.post("$URL/customers/updatePass",
          data: {"pass": newPassword, "email": validationEmail});
      if (response.data['status']) {
        hasError = false;
      } else {
        hasError = true;
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //                       ),
                  //                       Text(
                  //                         "To Change Your Password, Please Provide Your Email Account!",
                  //                         style: TextStyle(
                  //                             fontSize: 18,
                  ...
                  //                                                           "Return",
                  //                                                           style:
                  //                                                               TextStyle(fontSize: 17, fontFamily: "Poppins Bold"),
                  //                                                         ),
                  //                                                       ],
                  //                                                     )),
                  //                                                     width: double
                ...
                onClick: () {
                  ...
                  updatePassword().then((value) {
                    ...
                    alert(context,
                        title: Text("Privacy"),
                        content: Text(
                          "Your Security Code has been changed successfully..",
                          style: TextStyle(fontFamily: "Poppins Bold"),
                        ));
                  });
                },
